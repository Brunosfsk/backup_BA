    ...
    <div className="p-4 border rounded-lg flex justify-between items-center">
      {props.showBtn ? (
        <div className="flex items-center">
          <img src={props.foto} alt={props.nome} className="w-16 h-16 object-cover mr-4" />
          <div>
            ...
            <div className="flex items-center mt-2">
              <button className="bg-gray-300 text-gray-700 px-3 py-1 rounded-md mr-2" onClick={RemoveItem}>-</button>
              <p>{props.qtd}</p>
              <button className="bg-gray-300 text-gray-700 px-3 py-1 rounded-md ml-2" onClick={AddItem}>+</button>
            </div>
          </div>
        </div>
      ) : (
